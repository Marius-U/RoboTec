...
// char String1[] ={"AVR ATmega163 with TWI interface to I2C"};
...
****************************************************************************/
unsigned char Write_String(char String1[])
{	
	char temp0[2];
...
//
	...
	//do
	//{
		//state =  Write_String("Initialization..");    		//Write String1 to the display
	//}while(state != SUCCESS);	
//
